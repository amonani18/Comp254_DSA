...
/**
 * An abstract base class to ease the implementation of the question2.Map interface.
 *
...
public abstract class AbstractMap<K,V> implements Map<K,V> {
  ...
  /**
   * A concrete implementation of the question2.Entry interface to be used
   * within a question2.Map implementation.
   */
  protected static class MapEntry<K,V> implements Entry<K,V> {
    ...
    // public methods of the question2.Entry interface
    public K getKey() { return k; }
    public V getValue() { return v; }

    // utilities not exposed as part of the question2.Entry interface
