...
/**
 * An abstract base class providing some functionality of the question1.Tree interface.
 *
...
public abstract class AbstractTree<E> implements Tree<E> {
  ...
  /**
   * Returns true if question1.Position p has one or more children.
   *
  ...
  /**
   * Returns true if question1.Position p does not have any children.
   *
   * @param p    A valid question1.Position within the tree
  ...
  /**
   * Returns true if question1.Position p represents the root of the tree.
   *
   * @param p    A valid question1.Position within the tree
  ...
  /**
   * Returns the number of children of question1.Position p.
   *
   * @param p    A valid question1.Position within the tree
   * @return number of children of question1.Position p
   * @throws IllegalArgumentException if p is not a valid question1.Position for this tree.
   */
  @Override
  ...
  /** Returns the number of levels separating question1.Position p from the root.
   *
   * @param p A valid question1.Position within the tree
   * @throws IllegalArgumentException if p is not a valid question1.Position for this tree.
   */
  ...
  /**
   * Returns the height of the subtree rooted at question1.Position p.
   *
   * @param p A valid question1.Position within the tree
   * @throws IllegalArgumentException if p is not a valid question1.Position for this tree.
   */
  ...
  /**
   * Adds positions of the subtree rooted at question1.Position p to the given
   * snapshot using a preorder traversal
   * @param p       question1.Position serving as the root of a subtree
