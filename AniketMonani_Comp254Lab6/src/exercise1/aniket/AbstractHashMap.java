...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  protected float loadFactor;			 // loadFactor
  ...
  private void initialize() {
    ...
    System.out.print("Enter load you need to put (1 < 0.5): ");
    this.loadFactor = scanner.nextFloat();
  ...
  public V put(K key, V value) {
    ...
    if (n > capacity * loadFactor)  // keep load factor from user input
      resize(capacity * 2 - 1);
    return answer;
  }
