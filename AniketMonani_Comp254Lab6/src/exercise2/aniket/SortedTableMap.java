...
public class SortedTableMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  /**
   * Returns an iterable containing all entries in the map.
   * @return iterable containing all the entries
   */
  @Override
  public Iterable<Entry<K,V>> entrySet() { return snapshot(0, null); }

  /**
   * Returns an iterable containing all entries with keys in range [fromKey, toKey).
   * @param fromKey  lower bound of the range of keys (inclusive)
   * @param toKey    upper bound of the range of keys (exclusive)
   * @return iterable with keys in range [fromKey, toKey)
   * @throws IllegalArgumentException if the keys are not compatible with the map
   */
  @Override
  ...
  public static void main(String[] args) {
    // Create a SortedTableMap instance
    ...
    map.put("Aniket", "35");
    map.put("John", "23");
    map.put("Noah", null); // Insert a key with null value

    System.out.println("Contains 'Aniket': " + map.get("Aniket") + "   Statement is " + map.containKey("Aniket"));
    System.out.println("Contains 'Aniket': " + map.get("Noah") + "   Statement is " + map.containKey("Noah"));
    System.out.println("Contains 'David': " + map.get("David") + "   Statement is " + map.containKey("David"));
  }
}